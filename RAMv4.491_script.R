...
tbbest.data[1:5,1:7]
rownames(tbbest.data)#for 1955-2014, I want row 156-215. Or should this be 1950-2018?
tbbestsub<-tbbest.data[156:215,]
str(tbbestsub)#filter so that # NAs per column is less than 30?

#figure out how to assign FAO regions to tbbest and the other fishing effort ts.
#focus on the 3 fao regions that were hotspots of coherence, IOE, ANE and PWC.
